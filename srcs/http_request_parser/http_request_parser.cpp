...
// /*   Updated: 2022/11/02 15:04:01 by tevan-de      ########   odam.nl         */
// /*                                                                            */
// /* ************************************************************************** */
...
// // Method	HTTPRequestParser::parse_method(std::string const& str) {
...
// static void	parse_scheme(std::string const& scheme_str, std::string& scheme, size_t& index) {
...
// static void	parse_authority(std::string const& authority_str, Authority& authority, size_t& index) {
...
// static void	parse_path(std::string const& path_str, Path& path, size_t& index) {
...
// static void	parse_query(std::string const& query_str, std::map<std::string, std::string>& query, size_t& index) {
...
// static void	parse_fragment(std::string const& fragment_str, std::string& fragment, size_t& index) {
...
// void	HTTPRequestParser::parse_uri(HTTPRequestLexer::Uri& uri, std::string const& str) {
// 	size_t		index = 0;
...
// 	parse_scheme(str, uri.scheme, index);
// 	parse_authority(str, uri.authority, index);
// 	parse_path(str, uri.path, index);
// 	if (str.substr(index).empty()) {
// 		std::cout << std::endl;
// 		return ;
// 	}
// 	parse_query(str, uri.query, index);
// 	if (!uri.query.empty()) {
...
// 	}
// 	else {
// 		parse_fragment(str, uri.fragment, index);
// 	}
// 	std::cout << std::endl;	
// }

// // void	HTTPRequestParser::parse_protocol(std::string const& protocol) {
...
// // void	HTTPRequestParser::parse_headers(std::vector<std::string> const& headers) {
// // 	size_t	pos;
