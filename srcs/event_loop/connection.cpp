...
void	Connection::select_virtual_server(void) {
	this->_virtual_server.initialize_virtual_server(this->_request.request_line.uri.get_authority_host(), this->_request.request_line.uri.get_path_full(), this->_virtual_servers.second);
